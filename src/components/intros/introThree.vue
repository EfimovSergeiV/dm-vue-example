<template>
  ...
  <section id="intro-wrap" class="intro-three-Wrap  text-left text-white">
    <b-container>
      <b-row>
        <b-col md="6" class="intro-three-LeftSection pb-5">
        ...
        <b-col md="6" class="intro-three-RightSection d-flex align-items-center">
            <div class="intro-three-ProductImage">
            <img
              src="@/assets/images/landing/svg/v3-header.svg"
