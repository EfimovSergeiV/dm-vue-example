    ...
    <b-container >
      <b-row>
        <b-col sm="12" >
          ...
          >
            Be Productive While working with a team
          </h1>
          <div class=" intro-eight-Description ">
            <p class="text-18 mb-4">
              Meet Dexam Highly customizable Pure Vue JS + Bootstrap 4 admin
              template. Dexam is built with Official Vue CLI tool, supports AOT
              compilation and uses Bootstrap Vue.
            </p>
          </div>

          <div class="intro-eight-Buttons mb-5">
            <a
              name=""
              id=""
              href=""
